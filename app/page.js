      ...
      <section className="about-section editorial-section">
        <div className="container about-grid">
          <div className="about-image-wrapper">
            {/* Using a placeholder for George's photo until provided */}
            <div className="george-placeholder">
              <span className="font-serif italic">"I drive the miles, you make the memories."</span>
            </div>
          </div>
